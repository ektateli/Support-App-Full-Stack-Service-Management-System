      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="relative">
          <button 
            ...
            className="flex items-center gap-2 p-1.5 rounded-2xl hover:bg-slate-50 transition-all border border-transparent hover:border-slate-100 group cursor-pointer"
          >
            <div className="  cursor-pointer flex flex-col items-end hidden md:flex  cursor-pointer">
            ...
            <ChevronDown className={`w-6 h-6  cursor-pointer text-slate-600 transition-transform duration-200 ${showDropdown ? 'rotate-180' : ''}`} />
          </button>
