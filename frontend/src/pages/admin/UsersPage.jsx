          ...
          >
            ...
            <div className="p-8 space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                {emailError && (
                  <p className="text-[11px] text-rose-500 font-semibold ml-1">
                    {emailError}
                  </p>
                )}
              </div>
            ...
            <div className="p-8 bg-slate-50 border-t border-slate-100 flex flex-col sm:flex-row gap-3">
              <button
                type="button"
                onClick={closeModal}
                className="flex-1 px-6 py-4 rounded-2xl text-slate-600 font-bold cursor-pointer hover:bg-slate-100 transition-colors border border-slate-200"
              >
                Discard
              </button>
              <button className="flex-1 flex cursor-pointer items-center justify-center gap-2 bg-indigo-600 text-white px-6 py-4 rounded-2xl font-black shadow-xl shadow-indigo-100 hover:bg-indigo-700 transition-all active:scale-95">
          ...
          <div className="bg-white w-full max-w-sm rounded-[2rem] shadow-2xl relative z-10 overflow-hidden animate-scale-in">
            ...
            <div className="px-8 pb-8 flex flex-col gap-3">
              <button
                ...
                disabled={isDeleting}
                className="w-full bg-rose-600 text-white py-4 rounded-2xl font-black shadow-xl shadow-rose-100 hover:bg-rose-700 transition-all active:scale-95 flex items-center justify-center gap-2 disabled:opacity-70 cursor-pointer"
              >
              ...
              <button
                onClick={() => setShowDeleteConfirm(false)}
                disabled={isDeleting}
                className="w-full bg-slate-100 text-slate-600 py-4 rounded-2xl font-bold hover:bg-slate-200 transition-all active:scale-95 disabled:opacity-50 cursor-pointer"
              >
                Cancel
              </button>
            </div>
