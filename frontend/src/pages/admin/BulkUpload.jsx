...
export default function BulkUpload() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 animate-fade-in max-w-6xl mx-auto space-y-8">
      ...
      {/* Feedback Alert */}
      {msg && (
        <div className={`flex items-center gap-3 p-5 rounded-[1.5rem] border animate-scale-in shadow-sm ${msgType === "success"
        ...
        <div className="lg:col-span-8 space-y-8">
              ...
              <label className="group relative flex flex-col items-center justify-center w-full min-h-[300px] border-2 border-dashed border-slate-200 rounded-[2rem] hover:border-indigo-400 hover:bg-indigo-50/30 transition-all cursor-pointer overflow-hidden">
                ...
                {file ? (
                  <div className="text-center p-6 animate-scale-in">
                    ...
                    <button
                      onClick={removeFile}
                      className="inline-flex items-center gap-2 text-rose-500 text-xs font-bold bg-rose-50 px-4 py-2 cursor-pointer rounded-xl transition-all active:scale-95"
                    >
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between px-2">
              ...
              <button onClick={loadUploads} className="text-[10px] font-black uppercase text-indigo-600 hover:text-indigo-700 tracking-widest cursor-pointer">
                Refresh List
              </button>
            </div>
