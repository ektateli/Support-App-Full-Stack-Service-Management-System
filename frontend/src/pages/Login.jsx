...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Logic maintained: calling the endpoint
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  type="email"
                  className={`w-full bg-slate-50/50 border pl-11 pr-4 py-3.5 rounded-xl transition-all outline-none text-slate-800 placeholder:text-slate-400 ${emailError
            ...
            >
              <div className="relative flex items-center text-lg justify-center gap-2 cursor-pointer">
                {loading ? (
                  <>
